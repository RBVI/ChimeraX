...
UBUNTU_DEPENDENCIES = {
    ...
    "22.04": {
        ...
        "libffi8": "3.4.2",
        "libfontconfig1": "2.13.1",
        "libfreetype6": "2.11.1+dfsg",
        "libgbm1": "23.2.1",
        "libgcc-s1": "12.3.0",
        "libgdk-pixbuf-2.0-0": "2.42.8+dfsg",
        "libgfortran5": "12.3.0",
        "libgl1": "1.4.0",
        "libglib2.0-0": "2.72.4",
        "libglu1-mesa": "9.0.2",
        "libgomp1": "12.3.0-1ubuntu1~22.04.2",
        "libgssapi-krb5-2": "1.19.2",
        "libgstreamer-gl1.0-0": "1.20.1",
        "libgstreamer-plugins-base1.0-0": "1.20.1",
        "libgstreamer1.0-0": "1.20.3",
        "libgtk-3-0": "3.24.33",
        "liblzma5": "5.2.5",
        "libncursesw6": "6.3",
        "libnsl2": "1.3.0",
        ...
        "libnss3": "3.98",
        "libosmesa6": "23.2.1",
        "libpango-1.0-0": "1.50.6+ds",
        "libpangocairo-1.0-0": "1.50.6+ds",
        "libpcsclite1": "1.9.5",
        "libpulse0": "15.99.1+dfsg1",
        "libspeechd2": "0.11.1",
        "libsqlite3-0": "3.37.2",
        "libssl3": "3.0.2",
        "libstdc++6": "12.3.0",
    ...
    "24.04": {
        ...
        "libatk1.0-0t64": "2.52.0",
        "libatomic1": "14.2.0",
        "libbz2-1.0": "1.0.8",
        "libc6": "2.39",
        "libcairo-gobject2": "1.18.0",
        "libcairo2": "1.18.0",
        "libcrypt1": "4.4.36",
        "libcups2t64": "2.4.7",
        "libdbus-1-3": "1.14.10",
        ...
        "libgbm1": "24.2.8",
        "libgcc-s1": "14.2.0",
        "libgdk-pixbuf-2.0-0": "2.42.10+dfsg",
        "libgfortran5": "14.2.0",
        "libgl1": "1.7.0",
        ...
        "libgstreamer-gl1.0-0": "1.24.2",
        "libgstreamer-plugins-base1.0-0": "1.24.2",
        "libgstreamer1.0-0": "1.24.2",
        "libgtk-3-0t64": "3.24.41",
        "liblzma5": "5.6.1+really5.4.5",
        "libncursesw6": "6.4+20240113",
        "libnspr4": "4.35",
        "libnss3": "3.98",
        "libosmesa6": "24.2.8",
        "libpango-1.0-0": "1.52.1+ds",
        "libpangocairo-1.0-0": "1.52.1+ds",
        "libpcsclite1": "2.0.3",
        "libpulse0": "16.1+dfsg1",
        "libspeechd2": "0.12.0~rc2",
        "libsqlite3-0": "3.45.1",
        "libssl3t64": "3.0.13",
        "libstdc++6": "14.2.0",
        ...
        "libwayland-cursor0": "1.22.0",
        "libwayland-egl1": "1.22.0",
        "libx11-6": "1.8.7",
        "libx11-xcb1": "1.8.7",
        "libxcb-cursor0": "0.1.4",
        "libxcb-glx0": "1.15",
        "libxcb-icccm4": "0.4.1",
        "libxcb-image0": "0.4.0",
        "libxcb-keysyms1": "0.4.0",
    ...
    "26.04": {
        ...
        "libgfortran5": "16-20260322-1ubuntu1",
        "libgl1": "1.7.0-3",
...
def main():
    ...
    if len(sys.argv) >= 3:
        build = sys.argv[2]
        if build not in ['release', 'candidate', 'daily', 'github-techpreview', 'techpreview', 'canary']:
            error = True
