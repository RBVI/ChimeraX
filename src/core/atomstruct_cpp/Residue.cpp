...
const std::set<AtomName> Residue::aa_min_chain_names = {
    "C", "CA", "N"};
const std::set<AtomName> Residue::aa_max_chain_names = {
    "C", "CA", "N", "O", "OXT", "OT1", "OT2"};
const std::set<AtomName> Residue::na_min_chain_names = {
    "O3'", "C3'", "C4'", "C5'", "O5'", "P"};
const std::set<AtomName> Residue::na_max_chain_names = {
