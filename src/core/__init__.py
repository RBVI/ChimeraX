...
_class_class_init = {
    ...
    'CylinderColor': '.commands.scolor',
    'Drawing': '.graphics',
    'Generic3DModel': '.generic3d',
    'GradientColor': '.commands.scolor',
    'GridDataState': '.map.session',
    'HeightColor': '.commands.scolor',
    'Job': '.tasks',
    ...
    'StructureSeq': '.atomic',
    'Surface': '.models',
    'SurfaceColorers': '.commands.scolor',
    'Tasks': '.tasks',
    'Tools': '.tools',
    'TriangleInfo': '.stl',
    'Undo': '.undo',
