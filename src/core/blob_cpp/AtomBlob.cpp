...
static PyMethodDef AtomBlob_methods[] = {
    ...
    { (char*)"subtract", blob_subtract<AtomBlob>, METH_O,
        (char*)"subtract atom blobs" },
    { NULL, NULL, 0, NULL }
};

static PyNumberMethods AtomBlob_as_number = {
    0,                                    // nb_add
    (binaryfunc)blob_subtract<AtomBlob>,  // nb_subtract
    0,                                    // nb_multiply
    0,                                    // nb_remainder
    0,                                    // nb_divmod
    0,                                    // nb_power
    ...
    0,                                    // nb_lshift
    0,                                    // nb_rshift
    (binaryfunc)blob_intersect<AtomBlob>, // nb_and
    0,                                    // nb_xor
    (binaryfunc)blob_merge<AtomBlob>,     // nb_or
    0,                                    // nb_int
    0,                                    // nb_reserved
    0,                                    // nb_float
    0,                                    // nb_inplace_add
...
PyTypeObject AtomBlob_type = {
    ...
    0, // tp_reserved
    0, // tp_repr
    &AtomBlob_as_number, // tp_as_number
    0, // tp_as_sequence
