...
from chimerax.core import configinfo, session, core_settings
from chimerax.core import toolshed, attributes, undo, tools
from chimerax.core import startup, commands, requirements

from chimerax.core.commands import command_function, run, StringArg
...
def init_nogui(event_loop=True):
