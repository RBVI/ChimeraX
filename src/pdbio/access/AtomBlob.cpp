...
static int
AtomBlob_init(PyObject *self, PyObject *args, PyObject *kw)
{
    char *kw_list[] = {NULL};
    if (! PyArg_ParseTupleAndKeywords(args, kw, "", kw_list))
        return -1;
    AtomBlob* atomblob = static_cast<AtomBlob*>(self);
    (void) new(atomblob) AtomBlob();
    return 0;
}
...
static PyGetSetDef AtomBlob_getset[] = {
    ...
    { (char*)"residues", ab_residues, NULL, (char*)"residue blob", NULL},
