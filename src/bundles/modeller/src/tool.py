...
class ModellerLauncher(ToolInstance):
    ...
    def __init__(self, session, tool_name):
        ...
        from PySide2.QtWidgets import QListWidget, QFormLayout, QAbstractItemView, QGroupBox, QVBoxLayout
...
class ModellerResultsViewer(ToolInstance):
    ...
    def _finalize_init(self, session, models, attr_names, scores_fetched=False):
        ...
        from PySide2.QtWidgets import QTableWidget, QVBoxLayout, QAbstractItemView, QWidget, QPushButton
        layout = QVBoxLayout()
