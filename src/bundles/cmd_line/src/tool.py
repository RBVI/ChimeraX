...
class CommandLine(ToolInstance):
    ...
    def __init__(self, session, tool_name):
        ...
        from Qt.QtCore import Qt
        self.tool_window.manage(placement=side, fixed_size=True, allowed_areas=Qt.DockWidgetArea.LeftDockWidgetArea | Qt.DockWidgetArea.RightDockWidgetArea | Qt.DockWidgetArea.BottomDockWidgetArea)
        self._in_init = False
...
class _HistoryDialog:
    ...
    def __init__(self, controller, typed_only):
        ...
        remember_layout.setSpacing(1)
        main_layout.addLayout(remember_layout)
        num_cmd_frame = QFrame(parent)
        remember_layout.addWidget(num_cmd_frame)
        ...
        reminder = QLabel("Remembered commands include those generated by\n"
            " tools/menus/toolbar as well as typed commands")
        from chimerax.ui import shrink_font
        shrink_font(reminder)
        remember_layout.addWidget(reminder, alignment=Qt.AlignCenter)
