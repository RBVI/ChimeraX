...
run(session, "open test-data/chimera_test.pdb; open test-data/chimera_test.xtc str #1")
...
run(session, "close; open test-data/start.pdb; open test-data/test.dcd str #1")
