...
class StructureData:
    ...
    def chain_trace_atoms(self):
        ...
        atoms are shown but the intervening C and N atoms are not shown.  For nucleic
        acid chains adjacent displayed P atoms with undisplayed intervening X and Y
