...
VOLUMEARRAY_IMEX int parse_uint8_n_array(PyObject *arg, void *carray);
VOLUMEARRAY_IMEX int parse_uint8_n4_array(PyObject *arg, void *carray);
...
VOLUMEARRAY_IMEX int parse_writable_double_n_array(PyObject *arg, void *farray);
