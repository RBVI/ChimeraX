...
class Mouse_Modes:
    ...
    def mouse_down(self, event):
        ...
        self.last_mouse_position = self.mouse_down_position = pos
    ...
    def wheel_zoom(self, event):
        import sys
        d = event.GetWheelRotation()/120.0   # Usually one wheel click is delta of 120
        psize = self.pixel_size()
        v = self.view
    ...
    def wheel_contour_level(self, event):
        d = event.GetWheelRotation()       # Usually one wheel click is delta of 120
        f = d/(120.0 * 30)
