...
<http://www.rbvi.ucsf.edu/chimerax/cgi-bin/bundle_tutorial.zip?name=tut_gui_html>`_
containing a folder named `tut_gui_html`.
...
The files in the ``tut_gui_html`` folder are:

- ``tut_gui_html`` - bundle folder
...
.. literalinclude:: ../../../src/examples/tutorials/tut_gui_html/bundle_info.xml
    :language: xml
    :linenos:
...
.. literalinclude:: ../../../src/examples/tutorials/tut_gui_html/src/__init__.py
    :language: python
    :linenos:
...
.. literalinclude:: ../../../src/examples/tutorials/tut_gui_html/src/gui.py
    :language: python
    :linenos:
...
.. literalinclude:: ../../../src/examples/tutorials/tut_gui_html/src/gui.html
    :language: html
    :linenos:
...
.. literalinclude:: ../../../src/examples/tutorials/tut_gui_html/src/docs/user/tools/Tutorial_GUI.html
    :language: html
    :linenos:
